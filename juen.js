...
var UM_VER = 20130312.1;
var a = location.search;
var id = location.host.split(".")[0];
if (a=="?a=settings") {
	div = document.getElementsByClassName('hr720')[0];
	opcje="<br /><br /><b>UnMod</b> ver: "+UM_VER+" - <i>simply made by JUEN/gg:1008732</i><br><BR>";
	opcje+='<iframe scrolling=no src="http://mega.szajb.us/juenizer/unmod/ver.php?ver='+UM_VER+'" width="500" style="margin-top: 3px;" frameborder=0 height="33"></iframe><BR>';
	...
	document.getElementById('content-mid').style.minHeight="1500px";
...
if (GM_getValue(id+"UM_OP_unmodon", true)) {
	...
	if (a=="?a=swr") {
		...
		tr = table.getElementsByTagName('tr');
			...
			if (td.innerHTML.length<135 && td.innerHTML.length>100) {
	...
	if (a=="?a=tasks") {
		...
		juenOpis('Zostań władcą ciemnych zaułków Miasta. Osiągnij 55 pkt. wpływów.','Gdy mamy już wymaganą wartość cechy, wystarczy podnieść o 1, bądź awansować o 1 poziom,  by zaliczyło zadanie.');
		...
		juenOpis('Gdy obudziłeś się wieczorem, na biurku znalazłeś dziwny list. Poznaczony śladami krwi, zawierał w sobie tylko słowa: "Ratuj", "Uwięziona" i "Daleko". Pisane w pośpiechu, w różnych miejscach pergaminu. Cóż to może oznaczać?','Należy wykonać udaną pielgrzymkę (10% szans ze trafimy na ten test), gdzie testem jest średnia Zwinności i Intela.');
		juenOpis('Gdy obudziłaś się wieczorem, na biurku znalazłeś dziwny list. Poznaczony śladami krwi, zawierał w sobie tylko słowa: "Ratuj", "Uwięziona" i "Daleko". Pisane w pośpiechu, w różnych miejscach pergaminu. Cóż to może oznaczać?','Należy wykonać udaną pielgrzymkę (10% szans ze trafimy na ten test), gdzie testem jest średnia Zwinności i Intela.');
		juenOpis('Wykaż się męstwem. Tylko to przyciągnie pod Twój sztandar wytrawnych łowców.','Należy wykonac udaną pielgrzymkę, gdzie test jest średnią sposta i intela. ');
